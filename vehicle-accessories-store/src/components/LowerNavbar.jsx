  ...
  return (
    <nav className="bg-gray-800 py-5 shadow-lg relative z-50">
      <ul className="flex justify-center space-x-10 text-gray-200 text-base font-semibold uppercase relative">
        {/* Interior Accessories with Click Dropdown */}
        <li className="relative">
          ...
          {openDropdown === "interior" && (
            <ul
              ...
              onMouseEnter={() => setOpenDropdown("interior")} // Keep dropdown open
              onMouseLeave={() => handleMouseLeave("interior")} // Close only when cursor leaves
            >
              {[
                "Seat Covers",
